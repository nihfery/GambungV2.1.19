...
var ICONS = {
  add: async () => (await import("./add-AOZHXHJI.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-G4UH4QUL.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-R644QJFT.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-XFXJF75Z.js")).appStoreSvg,
  apple: async () => (await import("./apple-JWEQJ24M.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-J3PCJG55.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-ZNRR7BYH.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-RFKCJJQL.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-K7WOJWJP.js")).arrowTopSvg,
  bank: async () => (await import("./bank-FCJROZWL.js")).bankSvg,
  browser: async () => (await import("./browser-W7DY7QXM.js")).browserSvg,
  card: async () => (await import("./card-MXDAOW5V.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-KRTQAOWW.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-XLBL3QQJ.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-Y6YZGHRU.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-YABT4TEQ.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-3FS6U6FC.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-DZ3IUTWY.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-FTPSDKAT.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-WUECH5DP.js")).clockSvg,
  close: async () => (await import("./close-KPI3QSLD.js")).closeSvg,
  compass: async () => (await import("./compass-ZOHJDROX.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-QIV3NZHW.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-4NJBAFVF.js")).copySvg,
  cursor: async () => (await import("./cursor-AM5YZIZA.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-UVDC7SDT.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-KZLJZ3GS.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-ECPZ25EO.js")).disconnectSvg,
  discord: async () => (await import("./discord-IR42PVZW.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-26D4YPP7.js")).etherscanSvg,
  extension: async () => (await import("./extension-MA6VYUPM.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-QJHFHRIC.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-YTO3S26T.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-SROXUE4F.js")).farcasterSvg,
  filters: async () => (await import("./filters-U4CPQAAR.js")).filtersSvg,
  github: async () => (await import("./github-MUTXEE62.js")).githubSvg,
  google: async () => (await import("./google-74JSJFIY.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-GH6ETTQZ.js")).helpCircleSvg,
  image: async () => (await import("./image-YRCUVBHT.js")).imageSvg,
  id: async () => (await import("./id-ZNMIX2XQ.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-HIBT46HB.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-LSZ2CL5K.js")).lightbulbSvg,
  mail: async () => (await import("./mail-27JEKNTI.js")).mailSvg,
  mobile: async () => (await import("./mobile-SZLROSSR.js")).mobileSvg,
  more: async () => (await import("./more-YEHNSQRF.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-DBHKDIUA.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-5IAOOT7V.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-OX77S4MD.js")).offSvg,
  playStore: async () => (await import("./play-store-ZLTY5ZET.js")).playStoreSvg,
  plus: async () => (await import("./plus-OSVFMFEE.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-3XO7L4UX.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-2U3KAQBT.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-WU2OQ5NS.js")).refreshSvg,
  search: async () => (await import("./search-W54KY2NS.js")).searchSvg,
  send: async () => (await import("./send-D4VQUQ2B.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-A5DVNFXI.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-ITIH55TW.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-PY2F5EYF.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-2OM6PRWN.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-OVQKM2AA.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-M5AB5EPP.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-WEFX2BFU.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-AH43Q3EE.js")).twitchSvg,
  twitter: async () => (await import("./x-AP3TBA3D.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-SS3AAYGX.js")).twitterIconSvg,
  verify: async () => (await import("./verify-7HELFCNH.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-WIY2Y532.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-LTJ5CX5V.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-K3OHBCG6.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-K3OHBCG6.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-K3OHBCG6.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-352LTL4T.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-6VX25LPE.js")).warningCircleSvg,
  x: async () => (await import("./x-AP3TBA3D.js")).xSvg,
  info: async () => (await import("./info-6TAY775F.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-7EIC2HXD.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-GCVWCGXN.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HTRXZ5MV.js.map
